...
import com.julun.huanque.common.widgets.kpswitch.widget.KPSwitchRootFrameLayout;
import com.julun.huanque.common.widgets.kpswitch.widget.KPSwitchRootLinearLayout;
import com.julun.huanque.common.widgets.kpswitch.widget.KPSwitchRootRelativeLayout;
...
public class KPSwitchRootLayoutHandler {
    ...
    public KPSwitchRootLayoutHandler(final View rootView) {
        ...
        if (rootContext instanceof Activity) {
            final Activity activity = (Activity) rootContext;
