 ...
 */
package com.julun.huanque.common.widgets.kpswitch.util;
...
//        final Activity activity = CommonInit.Companion.getInstance().getCurrentActivity();
        final Activity activity = MixedHelper.INSTANCE.getActivity(panelLayout.getContext());
        if (activity == null) {
            return;
        }
     ...
     * @see KPSwitchPanelLayoutHandler
     */
    public static void showPanel(final View panelLayout, View focusView) {
        KeyboardUtil.hideKeyboard(focusView);
//        return;
//        EventBus.getDefault().post(new EventCloseSoft());
//        Observable.timer(10, TimeUnit.MICROSECONDS)
//                .observeOn(AndroidSchedulers.mainThread())
//                .subscribe(new Observer<Long>() {
//                    @Override
//                    public void onSubscribe(Disposable d) {
//                        if (ViewCompat.isAttachedToWindow(panelLayout)) {
        ...
        triggerView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (panelLayout.getVisibility() == View.VISIBLE) {
                    ...
                    // panel is gone.
                    // to show panel.
                    KPSwitchConflictUtil.showPanel(panelLayout, focusView);
                    switchToPanel = true;
