...
import com.julun.huanque.common.widgets.kpswitch.IPanelHeightTarget;
...
//        EventBus.getDefault().post(new EventCloseSoft());
     ...
     *
     * @param activity contain the
     * @param target   whose height will be align tviewo the keyboard height.
...
//            ULog.i("DXCIK 触发onGlobalLayout监听");
...
//            ULog.i("DXCIK 软键盘是否显示  isKeyboardShowing = " + isKeyboardShowing);
        }
