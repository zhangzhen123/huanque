...
class UserEnterRoomRespBase : Serializable {
    ...
    //主题房间相关
    var themeRoom: Boolean = false//是否主题房
...
class UserEnterRoomRespDto : Serializable {
    ...
    //广告轮播图
    var ads: ArrayList<RoomBanner> = ArrayList()
    ...
    //端午节活动相关
//    var duanwu: BoatProgressEventBean? = null
    var roomMicInfo: MicInfo? = null
...
//    var extData: ExtData? = null
    ...
    //4.16新增字段 author:WanZhiYuan
    //是否显示翻牌入口
    var turnCardOpen: Boolean = false

    //4.18.0新增抽奖信息
    var drawInfo: DrawInfo? = null
