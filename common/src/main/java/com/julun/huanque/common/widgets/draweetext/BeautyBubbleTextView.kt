...
//                        gDrawable.alpha = (0.4 * 255).toInt()
        ...
        if (rt.isNotEmpty()) {
            ...
            if (StringHelper.isSvgaUrl(rt)) {
                ...
                sParams.topMargin = -(dp2px(3))
                sParams.rightMargin = -(dp2px(4))
                ...
                wParams.topMargin = -(dp2px(3))
                wParams.rightMargin = -(dp2px(4))
