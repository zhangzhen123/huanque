...
//        }
    ...
    public void setData(List<? extends Object> models, List<String> tips) {
        setData(R.layout.item_bga_banner_image, models, tips);
    }
    ...
    private void initViewPager() {
        ...
        if (mAutoPlayAble) {
            ...
            int zeroItem = Short.MAX_VALUE / 2 - (Short.MAX_VALUE / 2) % mViews.size();
    ...
    public void handleAutoPlayActionUpOrCancel(float xVelocity) {
        if (mViewPager != null) {
            if (mPageScrollPositionOffset == 0.0) {
                mViewPager.setCurrentItem(mPageScrollPosition);
                return;
            }
    ...
    private class PageAdapter extends PagerAdapter {
        ...
        @Override
        public int getCount() {
            return mViews == null ? 0 : (mAutoPlayAble ? Short.MAX_VALUE : mViews.size());
        }
