...
/** 直播间用户变更事件 **/
class RoomUserListEvent(var userCount: Int = 0, var visitorCount: Int = 0, var userList: List<UserInfoForLmRoom> = listOf())
...
/**PK结束**/
class PKFinishEvent(var programIds: List<Int> = arrayListOf(),
...
class PKResultEvent(var detailList: ArrayList<PKResultUser>? = null, var pkType: String = "",
                    var programIds: List<Int> = arrayListOf(),
                    var stageDetailList: ArrayList<PkStageDetail>? = null,
                    var template: PKExtra? = null) : Serializable
...
class SuperLuckGiftContext(var goodsName: String? = "", var coin: Long? = 0, var goodsPicId: String? = "", var nickname: String? = "")
...
data class MicAnchor(var status: String = "",
        // 主播封面
                     var prePic: String = "",
        //流id
                     var streamID: String = "",
...
data class PicBean(var B: String? = null, var S: String? = null, var O: String? = null, var selected: Boolean = false)

data class AdPublishContentBean(var city_map: String? = null,
...
data class LastPublishBean(var publish_type: String? = null, var status_date: Date? = null, var show_play_minutes: Int = -1,
...
data class QueryShowSnsTempletResult(var textList: ArrayList<String>? = null, var picList: ArrayList<PicBean>? = null, var lastPublish: LastPublishBean? = null)
 ...
 * @param seconds 倒计时
 */
data class YearSeckillResult(var giftPic: String = "", var secKillUrl: String = "", var seconds: Long = 0)
...
class PublicCustomMsgBean(var actionType: String = "", var actionData: Any? = null, var excludeRoomIds: List<Int> = arrayListOf())
...
class ChatRoomCardsChangeBean(
        ...
        var cardNum: Int = 0) : Serializable
