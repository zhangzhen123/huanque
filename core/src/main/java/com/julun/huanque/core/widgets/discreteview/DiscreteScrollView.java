package com.julun.huanque.core.widgets.discreteview;
...
import com.julun.huanque.core.widgets.discreteview.util.ScrollListenerAdapter;
import com.julun.huanque.core.widgets.discreteview.util.transform.DiscreteScrollItemTransformer;
...
public class DiscreteScrollView extends RecyclerView {
    ...
    public void setScrollEnable(Boolean enable){
        ...
        if(l instanceof DiscreteScrollLayoutManager){
            DiscreteScrollLayoutManager ll = (DiscreteScrollLayoutManager)l;
            ll.setScrollEnable(enable);
        }
    }
