...
class DiscreteScrollLayoutManager extends RecyclerView.LayoutManager {
    ...
    public boolean canScrollHorizontally() {
        return mScrollEnable && orientationHelper.canScrollHorizontally();
//        return orientationHelper.canScrollHorizontally();
    }

    @Override
    public boolean canScrollVertically() {
        return mScrollEnable && orientationHelper.canScrollVertically();
...
//                    targetPosition, state.getItemCount()));
            ULog.Companion.e("target position out of bounds: position=%d, itemCount=%d");
            return;
        }
    }
