...
//                contentHolder.iv_picture.setImageResource(R.drawable.audio_placeholder);
                FrescoImageUtils.loadImageLocal( contentHolder.iv_picture,R.drawable.audio_placeholder,context);
            } else {
                FrescoImageUtils.loadNativeFilePathWithPx(contentHolder.iv_picture,path,overrideWidth,overrideHeight);
