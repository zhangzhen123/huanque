...
//        picture_tv_ok.setOnClickListener(this);
        ...
        picture_recycler.addItemDecoration(new GridSpacingItemDecoration(config.imageSpanCount,
                ScreenUtils.dip2px(this, 7), false));
...
//                    bundle.putString("video_path", media.getPath());
                    bundle.putParcelable(PictureVideoPlayActivity.VIDEO_MEDIA,media);
                    bundle.putBoolean(PictureVideoPlayActivity.IS_CHOOSE, true);
