...
//        VoiceManager.startRing(false)
    ...
    private fun initRecyclerView() {
        ...
        val tagPic = mutableListOf<LoginPicBean>().apply {
            add(LoginPicBean(1, 17, "杭州", "乐网"))
            add(LoginPicBean(2, 18, "上海", "勒沃"))
            add(LoginPicBean(3, 19, "苏州", "推图"))
            add(LoginPicBean(4, 20, "无锡", "离领"))
            add(LoginPicBean(5, 21, "常州", "匹配"))
            add(LoginPicBean(6, 22, "南京", "看v"))
            add(LoginPicBean(7, 23, "天津", "啃维"))
            add(LoginPicBean(8, 24, "北京", "一环"))
            add(LoginPicBean(9, 24, "北京", "一环"))
            add(LoginPicBean(10, 24, "北京", "一环"))
            add(LoginPicBean(11, 17, "杭州", "乐网"))
            add(LoginPicBean(12, 18, "上海", "勒沃"))
            add(LoginPicBean(13, 19, "苏州", "推图"))
            add(LoginPicBean(14, 20, "无锡", "离领"))
            add(LoginPicBean(15, 21, "常州", "匹配"))
            add(LoginPicBean(16, 22, "南京", "看v"))
            add(LoginPicBean(17, 23, "天津", "啃维"))
            add(LoginPicBean(18, 24, "北京", "一环"))
            add(LoginPicBean(19, 24, "北京", "一环"))
            add(LoginPicBean(20, 24, "北京", "一环"))
            add(LoginPicBean(21, 17, "杭州", "乐网"))
            add(LoginPicBean(22, 18, "上海", "勒沃"))
            add(LoginPicBean(23, 19, "苏州", "推图"))
            add(LoginPicBean(24, 20, "无锡", "离领"))
            add(LoginPicBean(25, 21, "常州", "匹配"))
            add(LoginPicBean(26, 22, "南京", "看v"))
            add(LoginPicBean(27, 23, "天津", "啃维"))
            add(LoginPicBean(28, 24, "北京", "一环"))
            add(LoginPicBean(29, 24, "北京", "一环"))
            add(LoginPicBean(30, 24, "北京", "一环"))
            add(LoginPicBean(31, 17, "杭州", "乐网"))
            add(LoginPicBean(32, 18, "上海", "勒沃"))
            add(LoginPicBean(33, 19, "苏州", "推图"))
            add(LoginPicBean(34, 20, "无锡", "离领"))
            add(LoginPicBean(35, 21, "常州", "匹配"))
            add(LoginPicBean(36, 22, "南京", "看v"))
            add(LoginPicBean(37, 23, "天津", "啃维"))
            add(LoginPicBean(38, 24, "北京", "一环"))
            add(LoginPicBean(39, 24, "北京", "一环"))
            add(LoginPicBean(40, 24, "北京", "一环"))
            add(LoginPicBean(41, 17, "杭州", "乐网"))
            add(LoginPicBean(42, 18, "上海", "勒沃"))
            add(LoginPicBean(43, 19, "苏州", "推图"))
            add(LoginPicBean(44, 20, "无锡", "离领"))
            add(LoginPicBean(45, 21, "常州", "匹配"))
            add(LoginPicBean(46, 22, "南京", "看v"))
            add(LoginPicBean(47, 23, "天津", "啃维"))
            add(LoginPicBean(48, 24, "北京", "一环"))
            add(LoginPicBean(49, 24, "北京", "一环"))
            add(LoginPicBean(50, 24, "北京", "一环"))
            add(LoginPicBean(51, 17, "杭州", "乐网"))
            add(LoginPicBean(52, 18, "上海", "勒沃"))
            add(LoginPicBean(53, 19, "苏州", "推图"))
            add(LoginPicBean(54, 20, "无锡", "离领"))
            add(LoginPicBean(55, 21, "常州", "匹配"))
            add(LoginPicBean(56, 22, "南京", "看v"))
            add(LoginPicBean(57, 23, "天津", "啃维"))
            add(LoginPicBean(58, 24, "北京", "一环"))
            add(LoginPicBean(59, 24, "北京", "一环"))
            add(LoginPicBean(60, 24, "北京", "一环"))
        }
